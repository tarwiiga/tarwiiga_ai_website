  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-br before:from-gray-900 before:via-green-200/20 before:to-gray-900">
          <Image
        ...
        <span className="pointer-events-none absolute p-2.5 before:absolute before:inset-0 before:rounded-full before:bg-gray-950 before:duration-300 group-hover:before:scale-110">
          <span className="relative flex items-center gap-3">
            ...
            <span className="text-sm font-medium leading-tight text-gray-300 border-2 border-black">
              Watch Demo
            </span>
          </span>
        </span>
